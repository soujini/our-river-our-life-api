...
Login.findOneAndUpdate({phoneNumber:JSON.parse(JSON.stringify(bodymen.body)).phoneNumber},{ $set: {phoneNumber:JSON.parse(JSON.stringify(bodymen.body)).phoneNumber}},{new: true, upsert: true })
